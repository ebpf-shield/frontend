...
export const Route = createFileRoute("/_auth/_organization/agents/$agentId")({
...
function AgentComponent() {
  ...
  return (
    <main className="size-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
